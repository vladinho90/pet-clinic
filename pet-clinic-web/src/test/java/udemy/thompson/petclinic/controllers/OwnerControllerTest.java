package udemy.thompson.petclinic.controllers;
...
class OwnerControllerTest {
    ...
    void listOwnersByIndex() throws Exception{
        ...
        mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get("/owners/index"))
                .andExpect(status().isOk())
                .andExpect(view().name("owners/index"))
                .andExpect(model().attribute("owners",hasSize(2)));
    }
    ...
    void displayOwner() throws Exception{
        ...
        mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get("/owners/123"))
                .andExpect(status().isOk())
